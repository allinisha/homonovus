...
export default class Articles extends React.Component {
  ...
  render() {
    ...
    // const defaultImg = window.screen.width > 1125 ? '../../static/img/default-bg.png' : '../../static/img/default-bg-small.png';
      ...
      <div className="articles-box">
        {
          ...
          // >
              ...
              list.map((article, index) => 
                ...
                <img className="article-cover" src={require(window.screen.width > 1125 ? '../../static/img/default-bg.png' : '../../static/img/default-bg-small.png')} />
                <div className="article-right">
